---
title: "Security and Maintenance Policy"
...
**Last sync:** Sep 7, 2026 | [View source](https://github.com/cosmos/security/blob/main/POLICY.md)
</Info>
...
Please read our [security policy](https://github.com/cosmos/security/blob/main/SECURITY.md) for a detailed breakdown of how bugs and vulnerabilities are to be handled for the Cosmos Stack.
